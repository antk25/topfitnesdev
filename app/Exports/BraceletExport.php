    ...
    */
    ...
    public function headings(): array
    {
        return [
            ...
            'seller_2_oldprice',
            'seller_2_link',
            'seller_3_price_market',
            'seller_3_oldprice_market',
            'seller_3_link_market',
            'seller_4_price_market',
            'seller_4_oldprice_market',
            'seller_4_link_market',
        ];
    }
    ...
    public function map($bracelet): array
    {
      return [
        ...
        $bracelet->sellers->pluck('pivot')->where('seller_id', 1)->pluck('price')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 1)->pluck('old_price')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 1)->pluck('link')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 2)->pluck('price')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 2)->pluck('old_price')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 2)->pluck('link')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 3)->pluck('price')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 3)->pluck('old_price')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 3)->pluck('link')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 4)->pluck('price')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 4)->pluck('old_price')->implode(','),
        $bracelet->sellers->pluck('pivot')->where('seller_id', 4)->pluck('link')->implode(','),
      ];
    }
}
