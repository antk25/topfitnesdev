                ...
                @foreach($overviews as $item)
                    <li>
                        <div class="grid gap-md items-start">
                            <a href="{{ route('pub.overviews.show', ['overview' => $item]) }}" class="articles-v3__img col-6@md col-7@xl">
                            ...
                            <div class="col-6@md col-5@xl">
                                <div class="text-component">
                                    <h4 class="articles-v3__headline"><a href="{{ route('pub.overviews.show', ['overview' => $item]) }}">{{ $item->name }}</a></h4>
