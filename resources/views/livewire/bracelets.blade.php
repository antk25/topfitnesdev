...
<div class="col-3@md col-6">
    ...
    <div class="flex gap-xxs margin-y-sm">
            <button class="btn--sm btn btn--primary" wire:click.prevent="clearAllFilter()">Сбросить фильтры</button>
            <span class="text-md">Найдено:
                <span class="text-bold">
                    {{ $bracelets->total() }} {{ trans_choice('браслет|браслета|браслетов',$bracelets->total()) }}
                </span>
            </span>
    </div>
    <section>

    <div class="padding-y-sm padding-0@md">
                 ...
                 <div class="margin-y-md">
                    ...
                    <li>
                        ...
                        <button class="chip__btn"  wire:click.prevent="clearFilter(`heart_rate`)">
                            <svg class="icon" viewBox="0 0 12 12"><title>Delete attribute</title>
                                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5">
                                <line x1="3" y1="3" x2="9" y2="9"/><line x1="9" y1="3" x2="3" y2="9"/></g>
                            </svg>
                        </button>
                        </span>
                    </li>
