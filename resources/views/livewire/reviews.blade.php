        ...
        <fieldset>
          <legend class="form-legend">Добавить новый отзыв</legend>
           ...
           <div class="col margin-y-sm">
            <label class="control-label form-label margin-bottom-xxs" for="period_use">Период владения браслетом <span class="text-bold">{{ $bracelet->name }}</span>:</label>
             <div class="select">
               <select class="select__input form-control" name="period_use" wire:model="period_use" id="period_use">
          ...
          <div class="margin-y-md">
            <div class="ratingem">
             <input type="radio" name="rating_user" wire:model="rating_user" value="5" id="rating-5">
             <label for="rating-5"></label>
             <input type="radio" name="rating_user" wire:model="rating_user" value="4" id="rating-4">
             <label for="rating-4"></label>
             <input type="radio" name="rating_user" wire:model="rating_user" value="3" id="rating-3">
             <label for="rating-3"></label>
             <input type="radio" name="rating_user" wire:model="rating_user" value="2" id="rating-2">
             <label for="rating-2"></label>
             <input type="radio" name="rating_user" wire:model="rating_user" value="1" id="rating-1">
          ...
          <div class="margin-y-md">
            ...
            <textarea class="form-control width-100%" rows="5" name="review_text" wire:model="review_text" id="commentNewContent"></textarea>
          </div>
