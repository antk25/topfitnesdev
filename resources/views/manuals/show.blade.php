    ...
    <div class="container max-width-sm">
        <div class="author shadow-md padding-sm">
            <a href="#0" class="author__img-wrapper">
                <img src="{{ $manual->user->getFirstMediaUrl('avatars') }}" alt="Author picture">
            </a>
            <div class="author__content text-component v-space-xxs">
                <p class="text-md text-bold">Автор: <a href="#0" rel="author">{{ $manual->user->name }}</a></p>
                <p class="color-contrast-medium">{{ $manual->user->about }}</p>
                <div class="flex gap-xxs">

                    <a href="{{ $manual->user->contacts['whatsapp'] }}"><svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 48 48" width="24px" height="24px">
                    ...
                    <a href="{{ $manual->user->contacts['telegram'] }}">
