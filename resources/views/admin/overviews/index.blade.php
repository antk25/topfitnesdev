...
<div class="text-component">
  ...
  <div class="bg radius-md padding-md shadow-xs">
    ...
    <a class="btn btn--success text-sm" href="{{ route('overviews.create') }}">Добавить обзор</a>
@if (count($overviews))
    ...
    <tr class="tbl__row">
        ...
        <td class="tbl__cell" role="cell">
            <div class="flex items-center">
              @if ($overview->getFirstMediaUrl('overviews'))
                
                <figure class="width-lg height-lg radius-50% flex-shrink-0 overflow-hidden margin-right-xs">
                <img class="block width-100% height-100% object-cover" src="{{ $overview->getFirstMediaUrl('overviews') }}" alt="Author picture">
                </figure>
        ...
        <td class="tbl__cell text-right" role="cell">
          ...
          <div class="grid gap-sm">
            <div class="col-6@md">
              <a class="btn btn--primary text-sm" href="{{ route('overviews.edit', ['overview' => $overview->id]) }}">
                Изменить
              </a>
            </div>
