...
<form class="form-template-v3" method="POST" action="{{ route('overviews.update', ['overview' => $overview->id]) }}" enctype="multipart/form-data">
    ...
    <fieldset class="margin-bottom-md padding-bottom-md border-bottom">
      <div class="text-component margin-bottom-md text-center">
        <h2>Изменить статью "{{ $overview->name }}"</h2>
      </div>
      ...
      <div class="grid gap-xxs margin-bottom-xs">
        <div class="col-6@md">
          ...
          <input class="form-control width-100%" type="text" name="name" id="name" value="{{ $overview->name }}">
      ...
      <div class="margin-bottom-xs">
        ...
        <input class="form-control width-100%" type="text" name="title" id="title" value="{{ $overview->title }}">
      </div>
    ...
    <tbody class="tbl__body">
      ...
      <tr class="tbl__row">
        ...
        <td class="tbl__cell  text-left" role="cell">
          <form method="POST" action="{{ route('overviews.updimg') }}">
            @csrf
        ...
        <td class="tbl__cell" role="cell">
         ...
         <td class="tbl__cell" role="cell">
          <form method="POST" action="{{ route('overviews.delimg') }}">
            @csrf
            <input type="text" hidden value="{{ $image->id }}" name="imgid">
