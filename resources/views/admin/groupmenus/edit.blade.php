    ...
    <fieldset class="margin-bottom-md padding-bottom-md border-bottom">
      ...
      <div class="margin-bottom-xs">
        <div class="grid gap-xxs items-center@md">
          ...
          <div class="col-8@md">
            <input class="form-control width-100% @error('name') form-control--error @enderror" type="text" name="name" id="name" value="{{ $groupmenu->name }}">
              @error('name')
      ...
      <div class="margin-bottom-xs">
        <div class="character-count js-character-count">
            ...
            <textarea class="form-control width-100% js-character-count__input"
                      ...
                      maxlength="500">{{ $groupmenu->about }}</textarea>
            <div
            ...
            <div class="select">
                <select
                    ...
                    <option value="">Выбрать место</option>
                        <option value="header" @if($groupmenu->place == 'header') selected @endif>Header</option>
                        <option value="footer" @if($groupmenu->place == 'footer') selected @endif>Footer</option>
                </select>
