  ...
  <div class="bg radius-md padding-md shadow-xs">
    ...
    <div class="int-table-actions padding-bottom-xxxs border-bottom border-contrast-lower" data-table-controls="table-1">
      ...
      <menu class="menu-bar js-int-table-actions__no-items-selected js-menu-bar">
        ...
        <li class="menu-bar__item " role="menuitem">
          <a href="{{ route('posts.create') }}"><svg class="icon menu-bar__icon" aria-hidden="true" viewBox="0 0 16 16">
            <g>
        ...
        <table class="int-table__table" aria-label="Interactive table example">
          ...
          <tbody class="int-table__body js-int-table__body">
            ...
            <tr class="int-table__row">
              ...
              <td class="int-table__cell">{{ $post->id }}</td>
              <td class="int-table__cell"><a href="{{ route('posts.edit', ['post' => $post->id]) }}">{{ $post->name }}</a></td>
              <td class="int-table__cell">{{ $post->slug }}</td>
              <td class="int-table__cell max-width-xxxxs">{{ $post->description }}</td>
