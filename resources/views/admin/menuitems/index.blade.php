...
<div class="text-component">
  ...
  <p class="text-sm color-contrast-medium">Все бренды, представленные на сайте.</p>
    ...
    <tr class="tbl__row">
        ...
        <td class="tbl__cell" role="cell">
            <div class="flex item-center">
                ...
                <p class="color-contrast-medium">{{ $menuitem->slug }}</p>
                </div>
            </div>
        </td>
        ...
        <td class="tbl__cell text-right" role="cell">
          ...
          <div class="grid gap-sm">
            <div class="col-6@md">
              <a class="btn btn--primary text-sm" href="{{ route('menuitems.edit', ['menuitem' => $menuitem->id]) }}">
                Изменить
              </a>
            </div>
            
            <div class="col-6@md">
              <form method="menurating" action="{{ route('menuitems.destroy', ['menuitem' => $menuitem->id]) }}">
                @csrf
                @method('DELETE')
