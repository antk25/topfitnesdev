    ...
    <fieldset class="margin-bottom-md padding-bottom-md border-bottom">
      ...
      <div class="margin-bottom-xs">
        <div class="margin-y-md">
          <div class="ratingem">
           <input type="radio" name="rating_user" value="5" id="rating-5">
           <label for="rating-5"></label>
           <input type="radio" name="rating_user" value="4" id="rating-4">
           <label for="rating-4"></label>
           <input type="radio" name="rating_user" value="3" id="rating-3">
           <label for="rating-3"></label>
           <input type="radio" name="rating_user" value="2" id="rating-2">
           <label for="rating-2"></label>
           <input type="radio" name="rating_user" value="1" id="rating-1">
      ...
      <div class="margin-bottom-xs">
        <div class="grid gap-xxs items-center@md">
          ...
          <div class="col-8@md">
            <textarea class="form-control width-100%" rows="5" name="review_text" id="review_text"></textarea>
          </div>
        </div>
      </div>
