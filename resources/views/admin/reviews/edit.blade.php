    ...
    <fieldset class="margin-bottom-md padding-bottom-md border-bottom">
        ...
        <div class="select">
          <select class="select__input form-control" name="bracelet_id">
            @foreach ($bracelets as $k => $v)
              <option value="{{ $k }}" @if ($braceletreview->name == $v)
                selected
              @endif>{{ $v }}</option>
            @endforeach
          </select>
      ...
      <div class="margin-bottom-xs">
        <div class="grid gap-xxs items-center@md">
          ...
          <div class="col-8@md">
            <input class="form-control width-100%" type="text" name="name" id="name" value="{{ $review->name }}">
          </div>
        </div>
      </div>
      ...
      <div class="margin-bottom-xs">
        <div class="grid gap-xxs items-center@md">
          ...
          <div class="col-8@md">
            <input class="form-control width-100%" type="email" name="email" id="email" value="{{ $review->email }}">
          </div>
        </div>
      </div>
      ...
      <div class="margin-bottom-xs">
        <div class="margin-y-md">
          <div class="ratingem">
           <input type="radio" name="rating_user" value="5" id="rating-5" @if ($review->rating_user == 5) checked @endif>
           <label for="rating-5"></label>
           <input type="radio" name="rating_user" value="4" id="rating-4" @if ($review->rating_user == 4) checked @endif>
           <label for="rating-4"></label>
           <input type="radio" name="rating_user" value="3" id="rating-3" @if ($review->rating_user == 3) checked @endif>
           <label for="rating-3"></label>
           <input type="radio" name="rating_user" value="2" id="rating-2" @if ($review->rating_user == 2) checked @endif>
           <label for="rating-2"></label>
           <input type="radio" name="rating_user" value="1" id="rating-1" @if ($review->rating_user == 1) checked @endif>
      ...
      <div class="margin-bottom-xs">
        <div class="grid gap-xxs items-center@md">
          ...
          <div class="col-8@md">
            <textarea class="form-control width-100%" rows="5" name="review_text" id="review_text">{{ $review->review_text }}</textarea>
          </div>
        </div>
      </div>
