...
<div class="bg radius-md padding-sm margin-bottom-sm border-dashed border-2 border">
    {{ Breadcrumbs::render('settings') }}
      ...
      <div class="grid gap-sm">
        <a class="link-card flex flex-column bg radius-md col-6@sm col-4@lg" href="{{ route('htmlcomponents.index') }}" aria-label="Link label">
          <div class="padding-md">
            <div class="flex flex-wrap gap-xs items-center">
              ...
              <div class="line-height-xs">
                <p class="text-lg font-semibold color-contrast-higher">{{ count($htmlcomponents) }}</p>
                <p class="color-contrast-medium margin-top-xxxs">Компоненты HTML</p>
              </div>
            </div>
          </div>
