    ...
    <fieldset class="margin-bottom-md padding-bottom-md border-bottom">
      ...
      <div class="grid gap-xxs margin-bottom-xs">
        <div class="col-6@md">
          ...
          <input class="form-control width-100%" type="text" name="name" id="name" value="{{ $manual->name }}">
      ...
      <div class="margin-bottom-xs">
        ...
        <input class="form-control width-100%" type="text" name="title" id="title" value="{{ $manual->title }}">
      </div>
