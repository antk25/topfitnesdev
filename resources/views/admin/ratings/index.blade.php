        ...
        <table class="int-table__table" aria-label="Interactive table example">
          ...
          <tbody class="int-table__body js-int-table__body">
            ...
            <tr class="int-table__row">
              ...
              <td class="int-table__cell">{{ $rating->id }}</td>
              <td class="int-table__cell"><a href="{{ route('ratings.edit', ['rating' => $rating->id]) }}">{{ $rating->title }}</a></td>
              <td class="int-table__cell">{{ $rating->slug }}</td>
              <td class="int-table__cell">{{ $rating->created_at->diffForHumans() }}</td>
              <td class="int-table__cell">
