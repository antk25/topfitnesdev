                                ...
                                <div class="select">
                                    <select
                                        ...
                                        @foreach ($users as $k => $v)
                                            <option value="{{ $k }}"
                                                    @if ($k == $rating->user->id) selected @endif>{{ $v }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="bg radius-md shadow-xs padding-md margin-bottom-md">
                            <div class="grid gap-xxs margin-bottom-xs">
                                <div class="col-6@md">
                                    ...
                                    <input class="form-control width-100% @error('name') form-control--error @enderror"
                                           type="text" name="name" id="name" value="{{ $rating->name }}">
                                    @error('name')
                                    <div role="alert"
                                         class="bg-error bg-opacity-20% padding-xxxs radius-md text-xs color-contrast-higher margin-top-xxs">
                                        <p><strong>Ошибка:</strong> {{ $message }}</p></div>
                                ...
                                <div class="col-6@md">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control flex-grow" type="text" name="slug" id="slug"
                                               value="{{ $rating->slug }}">
                                        <a href="/{{ $rating->slug }}" target="_blank"
                            ...
                            <div class="margin-bottom-xs">
                                ...
                                <input class="form-control width-100% @error('title') form-control--error @enderror"
                                       type="text" name="title" id="title" value="{{ $rating->title }}">
                                @error('title')
                                <div role="alert"
                                     class="bg-error bg-opacity-20% padding-xxxs radius-md text-xs color-contrast-higher margin-top-xxs">
                                    <p><strong>Ошибка:</strong> {{ $message }}</p></div>
                                ...
                                <div class="col-6@md">
                                    <div class="character-count js-character-count">
                                        ...
                                        <textarea class="form-control width-100% js-character-count__input"
                                                  ...
                                                  maxlength="300">{{ $rating->description }}</textarea>
                                        <div
            ...
            <pre><code class="language-html">
              ...
              alt="{{ $image->name }}"&gt;
                                            ...
                                            <form method="POST" action="{{ route('bracelets.updimg') }}">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control flex-grow" type="text" name="nameimg"
                                                           id="nameimg" value="{{ $image->name }}">
