...
<div class="text-component">
  ...
  <a class="btn btn--success text-sm" href="{{ route('sellers.create') }}">Добавить продавца</a>
...
@foreach ($sellers as $seller)
    <tr class="tbl__row">
        ...
        <td class="tbl__cell" role="cell">{{ $seller->popular }}</td>
        ...
        <td class="tbl__cell text-right" role="cell">
          ...
          <div class="grid gap-sm">
            <div class="col-6@md">
              <a class="btn btn--primary text-sm" href="{{ route('sellers.edit', ['seller' => $seller->id]) }}">
                Изменить
              </a>
            </div>
...
<div class="flex items-center">
  ...
  <p class="text-sm"><strong>Продавцов нет</strong></p>
</div>
...
<div class="flex margin-top-xxxs">
  ...
  <p class="text-sm opacity-70%">Вы еще не добавили ни одного продавца.</p>
</div>
</div>
@endif
    </div>
