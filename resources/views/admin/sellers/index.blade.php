...
<div class="text-component">
  <h1 class="text-lg">Продавцы</h1>
  <p class="text-sm color-contrast-medium">Управление продавцами.</p>
  <div class="bg radius-md padding-md shadow-xs">
    <p class="color-contrast-medium margin-bottom-sm">Таблица продавцов</p>
    ...
    <div class="int-table-actions padding-bottom-xxxs border-bottom border-contrast-lower" data-table-controls="table-1">
      ...
      <menu class="menu-bar js-int-table-actions__no-items-selected js-menu-bar">
        ...
        <li class="menu-bar__item " role="menuitem">
          <a href="{{ route('grades.create') }}"><svg class="icon menu-bar__icon" aria-hidden="true" viewBox="0 0 16 16">
            <g>
        ...
        <table class="int-table__table" aria-label="Interactive table example">
          ...
          <tbody class="int-table__body js-int-table__body">
            ...
            <tr class="int-table__row">
              ...
              <td class="int-table__cell">{{ $seller->id }}</td>
              <td class="int-table__cell"><a href="{{ route('sellers.edit', ['seller' => $seller->id]) }}">{{ $seller->name }}</a></td>
              <td class="int-table__cell max-width-xxxxs">{{ $seller->about }}</td>
              <td class="int-table__cell">{{ $seller->created_at->diffForHumans() }}</td>
              <td class="int-table__cell">
