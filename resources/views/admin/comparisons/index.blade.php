...
<div class="text-component">
  ...
  <div class="bg radius-md padding-md shadow-xs">
    <p class="color-contrast-medium margin-bottom-sm">Таблица статей-сравнений</p>
    ...
    <div class="int-table-actions padding-bottom-xxxs border-bottom border-contrast-lower" data-table-controls="table-1">
      ...
      <menu class="menu-bar js-int-table-actions__no-items-selected js-menu-bar">
        ...
        <li class="menu-bar__item " role="menuitem">
          <a href="{{ route('comparisons.create') }}"><svg class="icon menu-bar__icon" aria-hidden="true" viewBox="0 0 16 16">
            <g>
        ...
        <table class="int-table__table" aria-label="Interactive table example">
          ...
          <tbody class="int-table__body js-int-table__body">
            ...
            <tr class="int-table__row">
              ...
              <td class="int-table__cell">{{ $comparison->id }}</td>
              <td class="int-table__cell"><a href="{{ route('comparisons.edit', ['comparison' => $comparison->id]) }}">{{ $comparison->name }}</a></td>
              <td class="int-table__cell max-width-xxxxs">{{ $comparison->about }}</td>
              <td class="int-table__cell">{{ $comparison->created_at->diffForHumans() }}</td>
              <td class="int-table__cell">
