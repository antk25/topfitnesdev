    ...
    <fieldset class="margin-bottom-md padding-bottom-md border-bottom">
      ...
      <div class="grid gap-xxs margin-bottom-xs">
        <div class="col-6@md">
          ...
          <input class="form-control width-100%" type="text" name="name" id="name" value="{{ $comparison->name }}">
      ...
      <div class="margin-bottom-xs">
        ...
        <input class="form-control width-100%" type="text" name="title" id="title" value="{{ $comparison->title }}">
      </div>
      ...
      <div class="margin-bottom-xs">
        ...
        <div id="editor">{{ $comparison->content }}</div>
    ...
    <tbody class="tbl__body">
      ...
      <tr class="tbl__row">
        ...
        <td class="tbl__cell  text-left" role="cell">
          <form method="POST" action="{{ route('comparisons.updimg') }}">
            @csrf
        ...
        <td class="tbl__cell" role="cell">
         ...
         <td class="tbl__cell" role="cell">
          <form method="POST" action="{{ route('comparisons.delimg') }}">
            @csrf
            <input type="text" hidden value="{{ $image->id }}" name="imgid">
